...
public class BookingController {
  ...
  @PreAuthorize("hasAuthority('" + PermissionCode.MEMBER_LOYALTY + "')")
  @DeleteMapping("/{bookingCode}/voucher")
  public BookingOverviewResponse removeVoucher(
      Authentication authentication,
      @PathVariable String bookingCode
  ) {
    return bookingService.removeVoucher(bookingCode, requireAuthenticatedUser(authentication));
  }
